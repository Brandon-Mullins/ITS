...
1. Green banner: `✓ RS3 Quest Helper V2 — v0.6.5-LAYOUT-FIX`
2. Title bar badge: `v0.6.5-LAYOUT-FIX`
3. Footer: `v0.6.5-LAYOUT-FIX`
4. Browser console (F12): `RUNNING RS3 QUEST HELPER V2 v0.6.5-LAYOUT-FIX`
